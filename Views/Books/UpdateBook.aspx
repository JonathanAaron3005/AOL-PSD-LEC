<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="UpdateBook.aspx.cs" Inherits="PSD_LEC.Views.Books.UpdateBook" %>
    ...
    <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8" style="margin-top: 5%; min-height:75vh">
        ...
        <div class="d-flex justify-content-center" style="margin-top: 2.5%;">
            <div class="card row d-flex" style="width: 30rem;">
                ...
                <div>
                    <asp:Button ID="updateBook_Btn" runat="server" Text="Update Book" class="btn btn-success" style="width: 100%;"
                        onClick="updateBook_Btn_Click"/>
                </div>
